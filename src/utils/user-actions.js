...
// dev database - url to user image
let defImgURL = 'https://firebasestorage.googleapis.com/v0/b/fstore1-dev.appspot.com/o/userimages%2Fdefault2.png?alt=media&token=89913c6c-ce6b-4380-a7b8-b4da5a6af2db';
if (process.env.NODE_ENV === 'development') {
    // dev database - url to user image
    defImgURL = 'https://firebasestorage.googleapis.com/v0/b/fstore1-dev.appspot.com/o/userimages%2Fdefault2.png?alt=media&token=89913c6c-ce6b-4380-a7b8-b4da5a6af2db';
};
...
const addUserToFS = ( user, userName, imageURL ) => {
    ...
    .catch(function(error) {
        console.error("Error writing document to FireStore User store ", error);
    });
...
export const saveUser = (user, userName) => {
    ...
    console.log("imageURL:", defImgURL);
    ...
    // separate out Firestore
    addUserToFS(user, userName, defImgURL)
    ...
    //         imageURL: defImgURL
    //     })
    //     // .then(() => {  // Firebase actions after registration
    //     //     
    //     //     console.log("OK to perform funcs after registration ...")
    //     //     addUserToFBLeaderBoard(user, userName, defImgURL)
    //     //
    //     // })
    //     .then(() => {
    //         // Firestore actions after registration
    //         console.log("OK to perform funcs after registration ...")
    //         addUserToFS(user, userName, defImgURL)
    //     })
    //     .catch(function (error) {
